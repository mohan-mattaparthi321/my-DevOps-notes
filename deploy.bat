@REM =====================================================================================
@REM This script can deploy specified Microservice/Application to the specified COMPASS environment.
@REM Execute this script without any parameters to see usage
@REM Author Ankur Gargi
@REM Last update - 03212018
@REM =====================================================================================
...
if %_argcActual% EQU 5 (
	...
	git clone --branch=%BranchName% https://206561642@github.inbcu.com/Compass-Replatform/%ApplicationName%.git 
	set HTTP_PROXY=
	set HTTPS_PROXY=
	cd %ApplicationName%
)
